...
export { collection, doc, getDoc, getDocs, setDoc, updateDoc, deleteDoc, onSnapshot, query, orderBy, signInWithPopup, signOut, onAuthStateChanged, ref, uploadBytes, getDownloadURL, deleteObject };
export type { User };
